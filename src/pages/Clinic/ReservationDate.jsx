...
const ReservationDate = () => {
    ...
    for (let i = 1; i <= daysInMonth; i++) {
        calendarCells.push({
            type: 'current',
            day: i,
            dayOfWeek: (firstDayOfMonth + i - 1) % 7
        });
    }
    ...
    for (let i = 1; i <= remainingCells; i++) {
        calendarCells.push({
            type: 'next',
            day: i,
            dayOfWeek: (firstDayOfMonth + daysInMonth + i - 1) % 7
        });
    }
    ...
    const handleNextStep = () => {
        if (selectedDate) {
            navigate('/clinic/time', { state: { selectedDate } });
        }
    };
            ...
            <div className="bottom-action-area">
                <div className="date-info-container">
                    {selectedDate ? (
                        ...
                        <div className="reservation-history-link"
