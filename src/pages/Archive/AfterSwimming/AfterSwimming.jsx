      ...
      <main className="after-swimming-done">
        ...
        <div className="after-record-done-content">
          ...
          <img
            ...
            alt="저장 완료"
            className="after-record-done-icon"
          />
  ...
  return (
    <main className="after-swimming-page">
      ...
      <header className="after-archive-record-header">
        ...
        <button
          type="button"
          className="after-archive-record-back"
          onClick={() =>
            navigate(-1)
          }
          aria-label="이전"
      ...
      <section className="after-archive-record-content">
          ...
          <div className="after-photo-upload-row">
            ...
            {photo ? (
              <div className="after-photo-preview-wrapper">
                ...
                <button
                  type="button"
                  className="after-photo-remove-button"
                  onClick={
                    handlePhotoRemove
                  }
                >
              ...
              <label
                htmlFor="after-photo"
                className="after-photo-upload-box"
              >
                <span className="after-photo-upload-plus">
                  +
                </span>
            ...
            {SWIM_TIME_OPTIONS.map(
              (option) => (
                <button
                  key={option}
                  type="button"
                  className={`after-swim-time-button ${
                    swimTime ===
                    option
                      ? 'selected'
                      : ''
        ...
        <section className="after-archive-record-section">
          ...
          <p className="after-archive-record-description">
            현재 느끼고 있는 피부 불편 증상을
            선택해 주세요.
            (중복 선택 가능)
          </p>
            ...
            {SYMPTOM_OPTIONS.map(
              (option) => (
                <button
                  key={option}
                  type="button"
                  className={`after-symptom-button ${
                    symptoms.includes(
                      option
                    )
                      ? 'selected'
              ...
              <div className="after-severity-list">
                ...
                {symptoms.map(
                  (symptom) => (
                    <div
                      key={symptom}
                      className="after-severity-row"
                    >

                      <span className="after-severity-name">
                        {symptom}
                      </span>
                        ...
                        {SEVERITY_OPTIONS.map(
                          (severity) => (
                            <button
                              key={severity}
                              type="button"
                              className={`after-severity-button ${
                                symptomSeverity[
                                  symptom
                                ] ===
                                severity
        ...
        <section className="after-archive-record-section">
          ...
          <textarea
            className="after-archive-record-memo"
            value={memo}
            onChange={(event) =>
              setMemo(
                event.target.value
        ...
        <button
          type="button"
          className={`after-archive-record-save ${
            isComplete
              ? 'active'
              : ''
          }`}
